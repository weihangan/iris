...
# g2pw 多音字模型（g2pW.onnx 约 606MB 常驻内存）。
# ★ 默认关闭以省内存：改用 pypinyin 规则 + 内置多音字词典纠正。
#   如需开启：环境变量 CHAT5_G2PW=1（个别生僻多音字更准，代价 +606MB 常驻）。
is_g2pw_str = os.environ.get("CHAT5_G2PW", "0")
is_g2pw = is_g2pw_str.lower() == "true" or is_g2pw_str == "1"
if is_g2pw:
